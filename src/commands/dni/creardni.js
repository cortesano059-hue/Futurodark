...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(option => option.setName('edad').setDescription('Edad').setRequired(true))
        .addStringOption(option => option.setName('nacionalidad').setDescription('Nacionalidad').setRequired(true))
        .addStringOption(option => option.setName('psid').setDescription('ID de PlayStation').setRequired(true)),
